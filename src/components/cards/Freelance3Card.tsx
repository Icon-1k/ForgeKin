...
export default function Freelance3Card() {
    ...
    <>
      ...
      <form style={{ maxWidth: 400, margin: '0 auto' }} onSubmit={e => e.preventDefault()}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 28 }}>
          <button type="button" style={{ border: '2px solid #C7C7C7', background: '#F6F7F8', color: '#232323', borderRadius: 8, padding: '11px 60px', fontWeight: 500, fontSize: 18, minWidth: 140, cursor: 'pointer' }}>Back</button>
