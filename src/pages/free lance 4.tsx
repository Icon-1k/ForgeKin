...
export default function ForgeKinLogin() {
    ...
    <div style={{ fontFamily: "Inter,sans-serif", background: "#F7F8F9", minHeight: "100vh" }}>
      ...
      >
        <form autoComplete="off" style={{ marginTop: 3 }}>
          ...
          <div style={{ color: mutedText, marginBottom: 28, textAlign: "center", fontSize: 15 }}>
          ...
          <div style={{
            ...
            <svg viewBox="0 0 22 22" fill="none" width="22" height="22"
              style={{ position: "absolute", left: 9, top: 7, opacity: .55 }}>
          ...
          <label style={{ fontWeight: 600, fontSize: 15, marginBottom: 7, marginTop: 5, display: "block" }}>
            Password
          </label>
          <div style={{
            position: "relative", marginBottom: 12, marginTop: 3, height: 38
          }}>
            <svg viewBox="0 0 22 22" fill="none" width="22" height="22"
              style={{ position: "absolute", left: 9, top: 8, opacity: .55 }}>
            ...
            <svg
              ...
              style={{ position: "absolute", right: 7, top: 10, cursor: "pointer", opacity: .56 }}
            >
          ...
          <button type="button" style={{
            ...
            <svg width="23" height="23" viewBox="0 0 23 23" fill="none">
              <path fill="#000" d="M15.84 3.26002C15.16 3.94002 14.19 4.43002 13.22 4.35002C13.12 3.55002 13.55 2.72002 14.18 2.16002C14.81 1.57002 15.81 1.11002 16.7 1.13002C16.81 1.96002 16.47 2.80002 15.84 3.26002ZM18.05 7.13002C17.12 7.19002 16 6.55002 14.67 6.55002C13.33 6.55002 12.91 7.34002 11.57 7.34002C10.23 7.34002 9.57 6.55002 8.38 6.55002C6.98 6.59002 5.47 7.43002 4.57 8.87002C2.93 11.47 3.97 15.56 5.56 17.93C6.36 19.09 7.36 20.44 8.66 20.41C9.93 20.38 10.38 19.59 11.92 19.59C13.46 19.59 13.87 20.41 15.2 20.4C16.5 20.39 17.39 19.13 18.18 17.98C19.04 16.71 19.37 15.9 19.92 14.49C16.22 13.05 15.57 7.96002 19.09 7.18002C18.76 7.14002 18.4 7.11002 18.05 7.13002Z" />
            </svg>
            Continue with Apple
          </button>
        </form>
